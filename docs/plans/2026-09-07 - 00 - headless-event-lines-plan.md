...
## 2. `internal/eventjson`: per-variant data encoders
...
## 3. `internal/eventjson`: the line Writer, frames and facade
...
## 4. Headless: `--format` flag, the exit funnel and a frame on every path
