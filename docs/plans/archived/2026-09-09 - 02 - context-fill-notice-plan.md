...
**Date:** 2026-09-09, re-written 2026-09-13 · **Status:** executed (8/8, archived 2026-09-13) · **sized for:** ~200k-context host · **Base:** `a1ce9252` · **Bead:** `apogee-4kb` (its dependency `apogee-rxj`'s plan is archived; the slot is in the tree)
