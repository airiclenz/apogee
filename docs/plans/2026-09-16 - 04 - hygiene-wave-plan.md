...
## 8. Comment and doc drift sweep (apogee-bsg, prose half)
...
## 14. `ConfigHost` folds the config-file callbacks on `tui.Options` (apogee-970)
...
## 16. One pointer table keyed by `framePane` (apogee-agk, table half)
...
## 20. internal/tui `t.Parallel` sweep — group C (apogee-11s)
