...
## 2. The switch: `Config.ContextFillNotice`, a fifth `Generation` member, Bypass for a builtin advise
...
## 3. The `context-fill-notice` reaction
...
## 7. Announced-surface journey: the exact line the model sees
