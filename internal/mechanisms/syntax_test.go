...
// Broken Go content in a write call defers a correction pointing at the file and line — the Go
// parser is authoritative for Go.
func TestSyntaxBrokenGoDefersCorrection(t *testing.T) {
	t.Parallel()
...
func TestSyntaxBrokenGenericDefersCorrection(t *testing.T) {
	t.Parallel()
