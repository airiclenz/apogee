...
// GLOBAL, not per-hook-point: two Mechanisms that must never co-fire — a request shaper and a
// post-response repair claiming one symptom, say, which sit at different hook points — cannot both
// be enabled. A
