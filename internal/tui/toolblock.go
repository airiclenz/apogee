...
// cell while it still holds an open call. Its marker reaches the ROW's left edge, where a caller may
// hang a marker of its own in place of the tree's ┕ (blockState.marker).
//
