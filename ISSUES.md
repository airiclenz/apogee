...
- [X] the (multiple option) question tool should print out a well formatted summary of the question/options and given answer(s) in the collapsable tool after the question(s) have been answered. The tool's description for the model should also briefly state to no print the questions beforehand - as this uses up tokens unnecessaryly.
