...
- [ ] context sizes should be displayed so they stay in theit unit. E.g. 500k vs. 1.2M. I beleive this should be done with a global formatter that is used everywhere to make changes and maintenance easier.
