...
- [ ] The Inspector's unrecorded-reply note can land under the wrong request in a parallel
  ...
  do.
- [ ] A click in the band the inspector box grows into is swallowed instead of falling through.
